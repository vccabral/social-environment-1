...
class AirQualityDataPoint(models.Model):
	...
	def __unicode__(self):
		return "Air Quality: "+self.Arithmetic_Mean + " " + self.Units_of_Measure + " " + self.Parameter_Name + "@" + str(self.Year)
...
class ToxicDataPoint(models.Model):
	...
	def __unicode__(self):
		...
		return "Toxic Data: " + val + " " + self.UNIT_OF_MEASURE + " " + self.CHEMICAL_NAME + "@" + str(self.REPORTING_YEAR)
